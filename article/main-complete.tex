...
% NOT: Bu dosya, article/sections/ dizinindeki bölümleri birleştirerek oluşturulmuştur.
% Tam makale için aşağıdaki bölümleri sırayla ekleyin:
% 1. Giriş (main.tex'ten alınacak - zaten güncellenmiş)
% 2. Materyal ve Yöntem (main.tex'ten alınacak - zaten güncellenmiş)
% 3. Bulgular (sections/03-results-continued.tex)
% 4. Tartışma (sections/04-discussion.tex)
% 5. Simgeler (sections/05-symbols.tex)
% 6. Sonuçlar (sections/06-conclusions.tex)
% 7. Teşekkür ve Kaynaklar (sections/07-acknowledgments-references.tex)

% Şimdilik mevcut main.tex'in güncellenmiş içeriğini buraya ekliyoruz
