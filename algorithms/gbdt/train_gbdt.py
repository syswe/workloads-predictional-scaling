...
def main():
    try:
        ...
        output_dir = os.path.join('./train/models/gbdt_model/runs', args.run_id)
        ...
        metrics = {
            ...
            'model_params': {k: v for k, v in params.items() if not callable(v)},
        ...
        plt.title('GBDT Model - Pod Count Prediction')
        plt.xlabel('Time')
